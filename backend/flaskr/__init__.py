...
def create_app(test_config=None):
    ...
    class Questions(Resource):
        ...
        def post(self):
            """Handles either
                ...
                Get questions based on a search term. Returns any questions that search term is a substring of.
            """
            success_response = {
                "status": "success",
                "question": "",
    ...
    class PlayQuiz(Resource):
        ...
        def post(self):
            """Get questions to play the quiz. Takes category and previous question parameters and returns a random
            questions within the given category, if provided, and that is not one of the previous questions."""
